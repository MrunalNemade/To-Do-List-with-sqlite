...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *sourcePath = [[NSBundle mainBundle]pathForResource:@"MrunaliniNemade" ofType:@"sqlite"];
...
//    NSString *sourcePath = [[NSBundle mainBundle]pathForResource:@"TestData" ofType:@"sqlite"];
//    
//    NSString *destinationPath = [NSHomeDirectory()stringByAppendingString:@"Documents/"];
//    
